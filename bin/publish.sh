...
comment "*******************************************************************"
comment "This script will create a new release for the stackpack-splunk from master."
comment "Attention!!!"
...
comment "Check release pipeline running on  https://github.com/StackVista/stackpack-splunk/actions"
