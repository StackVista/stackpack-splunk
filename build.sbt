...
val stackpackName = "splunk"

/*
 * General build setup
 *
 * NOTE: publishing the Splunk StackPack is done by the StackState CI/CD pipeline. Its configuration is included in this build setup
  ...
  .settings(
    inThisBuild(List(
      ...
      scalaVersion := "2.12.6",
        ...
        resolvers ++= Vector("Stackstate Artifactory" at "https://artifactory.stackstate.io:443/artifactory/public", Resolver.mavenLocal),
